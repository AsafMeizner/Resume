...
export const aboutData: About = {
  ...
  aboutItems: [
    ...
    {label: 'Interests', text: 'Computers, Robotics, Planes, Lighting, and Sound Design', Icon: SparklesIcon},
...
export const socialLinks: Social[] = [
  ...
  {label: 'Twitter', Icon: TwitterIcon, href: 'https://twitter.com/MeiznerAsaf'},
];
